...
class BreedController {
  ...
  async list(req, res, next) {
    try {
      const breeds = await breedService.getAllBreeds(req.farmId);
  ...
  async getById(req, res, next) {
    try {
      const breed = await breedService.getBreedById(req.params.id, req.farmId);
  ...
  async create(req, res, next) {
    try {
      const breed = await breedService.createBreed(req.body, req.farmId);
  ...
  async update(req, res, next) {
    try {
      const breed = await breedService.updateBreed(req.params.id, req.body, req.farmId);
  ...
  async delete(req, res, next) {
    try {
      await breedService.deleteBreed(req.params.id, req.farmId);
