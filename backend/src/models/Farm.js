...
module.exports = (sequelize) => {
  return sequelize.define('Farm', {
    ...
    // Кого это хозяйство держит: назначение подставляется в карточку нового
    // кролика. Пусто — хозяйство ещё не сказало, и действует прежнее
    // «племя». Спрашивать про назначение каждого из двухсот кроликов
    // бессмысленно: почти везде ответ один и тот же.
    default_purpose: {
