...
const adjustStockSchema = Joi.object({
  ...
  // Сколько заплатили за корм. Необязательно, и это осознанно: «добавил»
  // значит и «закупил мешок», и «пересчитал, оказалось больше». Указана
  // стоимость — значит была покупка, и в книгу уйдёт расход.
  cost: Joi.number()
    .precision(2)
    .positive()
    .optional()
    ...
    .messages({
      ...
      'number.positive': 'Стоимость должна быть положительной'
    })
});
