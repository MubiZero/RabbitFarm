 ...
 * ней было нечем — ни кода по СМС, ни карты, ни дари в приложении, ни письма
 * справа налево. Человек видел свою страну, выбирал её и получал интерфейс
 * таджикской кириллицей, которую в Афганистане не читают. Вернуть её
