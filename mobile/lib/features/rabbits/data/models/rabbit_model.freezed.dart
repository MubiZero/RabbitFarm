...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,tagId,name,breedId,sex,birthDate,color,cageId,fatherId,motherId,status,purpose,acquiredDate,soldDate,deathDate,deathReason,currentWeight,notes,photoUrl,createdAt,updatedAt,breed,cage,father,mother]);
}

@override
String toString() {
    return 'RabbitModel(id: $id, tagId: $tagId, name: $name, breedId: $breedId, sex: $sex, birthDate: $birthDate, color: $color, cageId: $cageId, fatherId: $fatherId, motherId: $motherId, status: $status, purpose: $purpose, acquiredDate: $acquiredDate, soldDate: $soldDate, deathDate: $deathDate, deathReason: $deathReason, currentWeight: $currentWeight, notes: $notes, photoUrl: $photoUrl, createdAt: $createdAt, updatedAt: $updatedAt, breed: $breed, cage: $cage, father: $father, mother: $mother)';
}
