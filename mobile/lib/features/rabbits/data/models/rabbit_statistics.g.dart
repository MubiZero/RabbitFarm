...
_RabbitStatistics _$RabbitStatisticsFromJson(Map<String, dynamic> json) =>
    _RabbitStatistics(
...
Map<String, dynamic> _$RabbitStatisticsToJson(_RabbitStatistics instance) =>
    <String, dynamic>{
...
_BreedStats _$BreedStatsFromJson(Map<String, dynamic> json) => _BreedStats(
...
Map<String, dynamic> _$BreedStatsToJson(_BreedStats instance) =>
    <String, dynamic>{
