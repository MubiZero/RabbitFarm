...
///
/// Живут отдельно от карточки: одно и то же состояние подписывают и сама
/// карточка, и лист выбора, и подтверждение перед применением — расходиться
/// эти три места не должны.
