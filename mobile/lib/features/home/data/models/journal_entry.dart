...
enum JournalKind {
  ...
  /// Исправленная запись: кто и что поправил.
  ///
  /// Приходит оттуда же, откуда удаление, и по той же причине: сама запись
  /// в своём разделе показана уже исправленной и подписана тем, кто завёл
  /// её изначально, — о правке она не говорит ничего.
  edit;
