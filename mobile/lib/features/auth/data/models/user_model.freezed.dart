...
int get hashCode {
  final _this = this as UserModel;
  return Object.hash(runtimeType,_this.id,_this.email,_this.fullName,_this.role,_this.phone,_this.avatarUrl,_this.isActive,_this.isPlatformAdmin,_this.lastLoginAt,_this.digestEnabled,_this.createdAt,_this.updatedAt,_this.farm);
}

@override
String toString() {
  final _this = this as UserModel;
  return 'UserModel(id: ${_this.id}, email: ${_this.email}, fullName: ${_this.fullName}, role: ${_this.role}, phone: ${_this.phone}, avatarUrl: ${_this.avatarUrl}, isActive: ${_this.isActive}, isPlatformAdmin: ${_this.isPlatformAdmin}, lastLoginAt: ${_this.lastLoginAt}, digestEnabled: ${_this.digestEnabled}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, farm: ${_this.farm})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,email,fullName,role,phone,avatarUrl,isActive,isPlatformAdmin,lastLoginAt,digestEnabled,createdAt,updatedAt,farm);
}

@override
String toString() {
    return 'UserModel(id: $id, email: $email, fullName: $fullName, role: $role, phone: $phone, avatarUrl: $avatarUrl, isActive: $isActive, isPlatformAdmin: $isPlatformAdmin, lastLoginAt: $lastLoginAt, digestEnabled: $digestEnabled, createdAt: $createdAt, updatedAt: $updatedAt, farm: $farm)';
}
