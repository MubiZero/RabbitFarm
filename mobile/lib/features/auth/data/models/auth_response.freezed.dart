...
int get hashCode {
  final _this = this as AuthResponse;
  return Object.hash(runtimeType,_this.user,_this.accessToken,_this.refreshToken);
}

@override
String toString() {
  final _this = this as AuthResponse;
  return 'AuthResponse(user: ${_this.user}, accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken})';
}
...
class _AuthResponse implements AuthResponse {
  const _AuthResponse({required this.user, @JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'refresh_token') required this.refreshToken});
...
@override
int get hashCode {
    return Object.hash(runtimeType,user,accessToken,refreshToken);
}
